        ...
        <div className="grid items-center gap-8 xl:grid-cols-[0.85fr_1.15fr]">
          <div className="space-y-5">
            ...
            <p className="max-w-xl text-base leading-8 text-white/70 xl:text-lg">
              نظام متكامل لإدارة الموظفين، الحضور، الإجازات، الرواتب، الأوفر تايم، العهد، الموافقات، والتقارير داخل منصة واحدة موحدة.
            </p>
          </div>
      ...
      <div className="w-full max-w-md">
        <div className="mb-7 flex flex-col items-center text-center">
          <BrandLogo
            ...
            size="hero"
            showText={false}
            logoClassName="border-slate-300 shadow-2xl shadow-indigo-950/20 ring-4 ring-white/80 dark:border-slate-700 dark:ring-slate-800"
            imageClassName="p-2"
          />
          ...
          <p className="mt-2 text-sm font-bold text-indigo-600 dark:text-indigo-400">
            البوابة الموحدة لدخول الموظفين والمسؤولين
          </p>
        </div>

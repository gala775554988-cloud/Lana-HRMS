...
export default function PerformanceSettingsPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight capitalize">إعدادات performance</h1>
        <p className="text-muted-foreground">إدارة وتخصيص إعدادات performance.</p>
      </div>

...
export default async function EmployeeLayout({ children }: { children: ReactNode }) {
  ...
  try {
    ...
    return (
      <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="flex">
          ...
          <div className="sticky top-16 hidden h-[calc(100vh-4rem)] w-64 overflow-y-auto border-l border-white/10 bg-[hsl(var(--sidebar-bg))] text-[hsl(var(--sidebar-foreground))] lg:block">
    ...
    console.error("[EmployeeLayout] render failed", err);
    throw err;
  }
}

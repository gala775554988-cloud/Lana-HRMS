...
// Stats loaded in parallel via Suspense
...
export default async function EmployeeDashboard() {
  return (
    <main className="space-y-6" dir="rtl">
      ...
      {/* Stats loaded in background */}
      <Suspense fallback={<div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4"><div className="h-24 animate-pulse rounded-3xl bg-slate-200 dark:bg-slate-800" /></div>}>
        <DashboardStats />
      </Suspense>

      {/* Timeline loaded last */}
      <Suspense fallback={<div className="h-64 animate-pulse rounded-3xl bg-slate-200 dark:bg-slate-800" />}>
        <DashboardTimeline />
      </Suspense>
    </main>
  );

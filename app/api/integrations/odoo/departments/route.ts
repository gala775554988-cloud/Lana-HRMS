...
import { OdooDepartmentsService } from "@/lib/integrations/odoo/services/departments";
...
export async function GET(request: NextRequest) {
  try {
    ...
    const service = new OdooDepartmentsService(await OdooSyncService.forConnection(connectionId));
...
export async function POST(request: NextRequest) {
  try {
    ...
    const service = new OdooDepartmentsService(await OdooSyncService.forConnection(body.connectionId));

      ...
      >
        <div className="flex items-center gap-3">
          <BrandLogo
            ...
            size="hero"
            showText={false}
            logoClassName="border-slate-300 shadow-2xl shadow-[#F4708F]/10 ring-4 ring-white/80 dark:border-slate-700 dark:ring-slate-800"
            imageClassName="p-2"
          />
          <h1 className="text-2xl font-extrabold text-slate-900 dark:text-slate-100 sm:text-3xl">
            Lana <span className="font-medium text-[#F4708F]">HRMS</span>
          </h1>
        </div>

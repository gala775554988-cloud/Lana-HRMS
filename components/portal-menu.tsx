...
export function PortalMenu({ className = "" }: { className?: string }) {
  ...
  return (
    <nav className={cn("flex flex-wrap items-center gap-1.5 p-1.5 rounded-2xl bg-slate-100/80 dark:bg-slate-800/80 border border-slate-200/60 dark:border-slate-700/60", className)} dir="rtl">

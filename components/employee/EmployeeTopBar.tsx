      ...
      <div className="max-w-[1280px] mx-auto h-16 px-4 sm:px-6 flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex flex-1 max-w-md">
          <div className="relative w-full">
            ...
            <input
              ...
              placeholder="Search requests, documents, policies..."
              className="w-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl pl-10 pr-4 py-2 text-sm focus:outline-none focus:border-indigo-300 dark:focus:border-indigo-700 transition"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <button 
            ...
            className="ml-1 p-2 rounded-xl hover:bg-red-50 dark:hover:bg-red-950 text-red-600 transition"
            aria-label="Logout"
          >

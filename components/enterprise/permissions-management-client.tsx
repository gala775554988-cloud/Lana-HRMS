...
const FIELD_HINTS: Record<(typeof SENSITIVE_FIELDS)[number], string> = {
  nationalId: "عرض: يرى الرقم عند فتح ملف أي موظف. تعديل: يمكنه تغييره. إخفاء: لا يظهر له إطلاقاً في أي شاشة أو أداة (بما فيها المساعد الذكي).",
  ...
  profilePhotoUrl: "عرض: يرى صورة الموظف. تعديل: يمكنه تغييرها. إخفاء: لا تظهر له الصورة إطلاقاً (بما فيها عبر المساعد الذكي).",
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            لكل حقل: عرض فقط، تعديل، أو إخفاء تماماً (حتى عن المساعد الذكي) — محقق من جهة الخادم وليس مجرد إخفاء في الواجهة.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">

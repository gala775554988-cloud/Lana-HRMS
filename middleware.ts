...
const PUBLIC_API_PREFIXES = [
  ...
  "/api/integrations/odoo/sync/lazy-detail", // authenticates via internal sync token / session
  "/api/integrations/queue/process-jobs", // authenticates via CRON_SECRET / internal sync token

...
async function ensureDbSchema() {
  ...
  const sqlStatements = [
    ...
    `CREATE TABLE IF NOT EXISTS "WorkflowPathTemplate" ("id" TEXT NOT NULL, "workflowType" "WorkflowPathType" NOT NULL, "workflowName" TEXT NOT NULL, "sendToDirectManagerFirst" BOOLEAN NOT NULL DEFAULT true, "steps" JSONB NOT NULL, "updatedById" TEXT, "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP(3) NOT NULL, CONSTRAINT "WorkflowPathTemplate_pkey" PRIMARY KEY ("id"));`,

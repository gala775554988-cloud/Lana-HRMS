...
async function main() {
  ...
  await client.appSetting.upsert({ where: { key: "company.logo" }, update: { value: { url: "/favicon.svg" } }, create: { key: "company.logo", value: { url: "/favicon.svg" }, description: "Company logo URL" } });
